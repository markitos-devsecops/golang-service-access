# Golang Markitos Service Access
...
Este access tiene como objetivo ser una solución robusta para comenzar a desarrollar servicios de manera eficiente, asegurando las mejores prácticas de **seguridad** y **pruebas**. Además, se ha diseñado para ser fácilmente extensible y adaptable.
...
```bash
git clone https://github.com/markitos-devsecops/golang-service-access.git
cd golang-service-access
```
